    ...
    GETARTUCLES(state, result) {
        let compare = function (time) {
            return function (a, b) {
                ...
                hour = value3[0]
                minute = value3[1]
                counttime1 = parseInt(year) * 10000000 + parseInt(month) * 100000 + parseInt(day) * 1000 + parseInt(hour) * 100 + parseInt(minute)
                value1 = b[time].split('-')
                ...
                hour = value3[0]
                minute = value3[1]
                counttime2 = parseInt(year) * 10000000 + parseInt(month) * 100000 + parseInt(day) * 1000 + parseInt(hour) * 100 + parseInt(minute)
                if (result[1] == 1) {
